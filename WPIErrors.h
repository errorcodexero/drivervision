...
extern void wpi_setWPIError_print( const char *msg, const char *context );
extern void wpi_setWPIError_print( const char *msg );
#define	wpi_setWPIError(label) wpi_setWPIError_print(wpi_error_s_##label, NULL)
#define	wpi_setWPIErrorWithContext(label, context) wpi_setWPIError_print(wpi_error_s_##label, context)
